...
if ( ! function_exists( 'bauman_load_scripts' ) ){
    ...
    function bauman_load_scripts() {
        ...
        wp_enqueue_style( 'impstyles', get_template_directory_uri() . '/css/impstyles.css' );
		...
		wp_enqueue_style( 'bauman-theme', get_stylesheet_uri(), array('bauman-showcase', 'bauman-hero', 'bauman-portfolio', 'bauman-blog', 'bauman-shortcodes', 'bauman-assets', 'impstyles') );

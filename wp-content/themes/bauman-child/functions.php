...
function my_theme_enqueue_styles() {
	...
	$showcase_style = 'bauman-showcase';
	$portfolio_style = 'bauman-portfolio';
	$blog_style = 'bauman-blog';
	$shortcodes_style = 'bauman-shortcodes';
	$hero_style = 'bauman-hero';
	$assets_style = 'bauman-assets';
